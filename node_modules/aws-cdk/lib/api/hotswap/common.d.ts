 ...
 */
export declare function stringifyPotentialCfnExpression(value: any, assetParamsWithEnv: {
    [key: string]: string;
}): string;
export declare function assetMetadataChanged(change: cfn_diff.ResourceDifference): boolean;
